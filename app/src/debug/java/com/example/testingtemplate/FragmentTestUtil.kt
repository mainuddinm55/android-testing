...
inline fun <reified T : Fragment> launchFragmentInHiltContainer(
    ...
    @SuppressLint("PrivateResource") @StyleRes themeResId: Int = R.style.FragmentScenarioEmptyFragmentActivityTheme,
...
inline fun <reified T : Fragment> launchFragmentInHiltContainer(
    ...
    ActivityScenario.launch<HiltTestActivity>(startActivityIntent).onActivity { activity ->
        ...
        activity.supportFragmentManager.beginTransaction().add(android.R.id.content, fragment, "")
            .setMaxLifecycle(fragment, Lifecycle.State.RESUMED).commit()
